# Полный список инструментов и ресурсов

> Все ссылки проверены и актуальны. Цены могут измениться.
...
| Инструмент | Ссылка | Бесплатно? | Цена | Что делает |
|---|---|---|---|---|
| **Notion AI** | [notion.so](https://notion.so) | ✅ (Notion бесплатно) | $10/мес | Написание и организация |
| **Grammarly** | [grammarly.com](https://grammarly.com) | ✅ Базовый | $12/мес | Проверка текстов на английском |
| **Copy.ai** | [copy.ai](https://copy.ai) | ✅ Ограничено | $36/мес | Маркетинговые тексты |
| **Jasper** | [jasper.ai](https://jasper.ai) | ❌ | $39/мес | Продвинутый маркетинговый копирайтинг |
| **Gamma** | [gamma.app](https://gamma.app) | ✅ Ограничено | $8/мес | Презентации из ИИ |
...
| Инструмент | Ссылка | Бесплатно? | Цена | Что делает |
|---|---|---|---|---|
| **Microsoft Copilot** | [copilot.microsoft.com](https://copilot.microsoft.com) | ✅ Базовый | $20/мес | ИИ в Office |
| **Notion AI** | [notion.so](https://notion.so) | ✅ | $10/мес | Управление проектами + ИИ |
| **Otter.ai** | [otter.ai](https://otter.ai) | ✅ | $17/мес | Расшифровка совещаний |
| **Zapier** | [zapier.com](https://zapier.com) | ✅ Ограничено | $20/мес | Автоматизации |
| **Make** | [make.com](https://make.com) | ✅ Ограничено | $9/мес | Продвинутые автоматизации |

---

## 📰 Рекомендуемые рассылки

| Название | Ссылка | Язык | Частота | Для кого |
|---|---|---|---|---|
| **The Rundown AI** | [therundown.ai](https://therundown.ai) | Английский | Ежедневно | Для всех — сводка за 5 минут |
| **Ben's Bites** | [bensbites.com](https://bensbites.com) | Английский | Ежедневно | Новые инструменты |
| **Superhuman AI** | [superhuman.ai](https://superhuman.ai) | Английский | Еженедельно | Практические советы |
| **TLDR AI** | [tldr.tech/ai](https://tldr.tech/ai) | Английский | Ежедневно | Более техническое |
...
|---|---|---|
| **Co-Intelligence** | Ethan Mollick | Для всех — как работать с ИИ |
| **The AI Revolution in Medicine** | Peter Lee et al. | Интересующимся медициной и ИИ |
| **Impromptu** | Reid Hoffman | Предприниматели и бизнесмены |
