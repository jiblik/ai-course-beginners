...
const i18n = {
    ...
    ru: {
        ...
        'gate-subtitle': 'Полный практический курс — от «Что такое ChatGPT?» до уверенного использования в работе.',
        'gate-f1': '9 уроков + бонусные материалы',
        'gate-f2': '30+ готовых промптов для копирования',
        'gate-f3': 'Полный обзор всех ключевых ИИ-инструментов',
