...
const i18n = {
    he: {
        ...
        'gate-subtitle': 'קורס מעשי מקיף — מהיכרות ראשונית ועד שילוב שוטף של AI בעבודה שלכם.',
        'gate-f1': '9 שיעורים + חומרי בונוס',
        'gate-f2': '30+ פרומפטים מוכנים לשימוש מיידי',
        'gate-f3': 'סקירה של כל כלי ה-AI המרכזיים',
        'gate-f4': 'גישה לכל החיים + עדכונים תקופתיים',
        'gate-f5': 'החזר כספי מלא תוך 30 יום',
        'gate-price': '₪149',
        'gate-price-note': 'תשלום חד-פעמי',
        'gate-buy': 'רכשו את הקורס',
        'gate-have-access': 'כבר יש לי גישה',
        'modal-title': 'הכניסו סיסמת גישה',
        'modal-desc': 'הסיסמה נשלחה אליכם למייל לאחר הרכישה.',
        'modal-error': 'סיסמה שגויה. בדקו את המייל שקיבלתם בעת הרכישה.',
        'modal-submit': 'פתחו את הקורס',
        'modal-lost': 'שכחתם את הסיסמה?',
        lessonNames: {
    ...
    ru: {
        ...
        'gate-subtitle': 'Практический курс — от первого знакомства до уверенного использования ИИ в работе.',
        'gate-f1': '9 уроков + бонусные материалы',
        'gate-f2': '30+ готовых к использованию промптов',
        'gate-f3': 'Обзор всех ключевых ИИ-инструментов',
        'gate-f4': 'Пожизненный доступ + регулярные обновления',
        'gate-f5': 'Возврат денег в течение 30 дней',
        'gate-price': '$29',
        'gate-price-note': 'единоразовая оплата',
